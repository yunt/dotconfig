...
;; Time-stamp: <2010-01-07 17:02:26 Thursday by ahei>
...
;; 个人信息
(setq user-mail-address "ahei0802@126.com")
...
(load "highlight-symbol-settings")
...
(dolist (map (list emacs-lisp-mode-map lisp-interaction-mode-map java-mode-map
                   c-mode-base-map text-mode-map ruby-mode-map html-mode-map java-mode-map))
  (apply-define-key
   map
   `(("C-c M-C" copy-full-file-name))))
...
;; notification tool
(load "todochiku-settings")

(load "emacs-lisp-mode-settings")
