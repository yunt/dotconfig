...
--{{---| Theme | -------------------------------------
config_dir = ("/home/yunt/.config/awesome/")
...
browser = "firefox"
modkey = "Mod4"
mailmutt = "urxvtc -T 'Mutt' -g 90x25-20+34 -e mutt"
cal = "urxvtc -T 'Cal' -e cal"
...
vicious.register(memwidget, vicious.widgets.mem, '<span background="#777E76" font="UbuntuMono 12"> <span font="UbuntuMono 12" color="#EEEEEE" background="#777E76">$2MB </span></span>', 10)
memicon = wibox.widget.imagebox()
memicon:set_image(beautiful.widget_mem)

--{{--| Time and Date widget |-------
tdwidget = wibox.widget.textbox()
vicious.register(tdwidget, vicious.widgets.date, '<span font="UbuntuMono 12" color="#EEEEEE" background="#777E76"> %d %b, %H:%M</span>', 20)
...
vicious.register( batwidget, vicious.widgets.bat, '<span background="#92B0A0" font="UbuntuMono 12"><span font="UbuntuMono 12" color="#FFFFFF" background="#92B0A0">$1$2% </span></span>', 1, "C1BA" )
...
arr1:set_image("/home/yunt/.config/awesome/themes/powerarrow/icons/powerarrow/arr1.png")
